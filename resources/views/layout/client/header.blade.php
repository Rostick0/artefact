    ...
    <div class="container">
        <div class="header__container">
            ...
            <nav class="header__nav">
                ...
                <a class="header__nav_item" href="/portfolio">Portfolio</a>
                <a class="header__nav_item" href="/services">Services and prices</a>
                <a class="header__nav_item" href="/faq">Faq</a>
                <a class="header__nav_item" href="/panorams">Panorams</a>
